...
app.service('newsData',function($http) {
	this.getNews = function() {
	    return $http.get('http://api.randomuser.me/0.4/?results=20').success(function(data) {
...
app.controller('newsCtrl', function ($scope,newsData) {
	$scope.news = [];
	newsData.getNews().then(function(result){
		$('#loading').hide();
